/*
 * @Author: Ning Zhang
 * @Date: 2024-12-21 08:38:26
 * @Last Modified by: Ning Zhang
 * @Last Modified time: 2024-12-22 10:09:20
 */
...
namespace MetaWaveCompiler
{
    namespace util
    {
        ...
        public:
            ...
            friend std::ostream &operator<<(std::ostream &os, const std::pair<value_type1, value_type2> &p) { return os << "(" << p.first << ", " << p.second << ")"; }
            ...
            public:
                ...
                friend bool operator==(const ZipConstIterator &l, const ZipConstIterator &r) { return l.c1it == r.c1it && l.c2it == r.c2it; }
                friend bool operator!=(const ZipConstIterator &l, const ZipConstIterator &r) { return l.c1it != r.c1it || l.c2it != r.c2it; }
                std::pair<value_type1, value_type2> operator*() { return std::pair<value_type1, value_type2>(*c1it, *c2it); }
            ...
            ZipConstIterator begin() const { return ZipConstIterator(c1.begin(), c2.begin()); }
            ZipConstIterator end() const { return ZipConstIterator(c1.end(), c2.end()); }
